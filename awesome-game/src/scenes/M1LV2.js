...
{    
    ...
    update()
    {
        ...
        if(this.mechant1 === 0 && this.duel1 === false){
            ...
            this.ghost = this.physics.add.sprite(540, 320, 'ghost3')
            .setScale(1.5)
        ...
        //fin combat 2 vs ske2
            ...
            if(this.heroHP > 0 && this.mob2HP > 0 && this.duel1 === true && this.duel2 === false){
        ...
        //début du combat 3
        if(this.mechant3 === 0 &&  this.duel1 === true && this.duel2 === true && this.duel3 === false){
        ...
        //fin combat 3 vs ske3
            ...
            if(this.heroHP > 0 && this.mob3HP > 0 && this.duel1 === true && this.duel2 === true && this.duel3 === false){
